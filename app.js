...
var moonLight = new Restaurant ('asian', 'Moon Light Cafe', '$', '1919 S Jackson St, Seattle, WA 98144', '(206) 322-3378', '11:00AM to 9:30PM', 'https://www.yelp.com/biz/moonlight-cafe-seattle', './images/asian/moonLight.jpg');
var bambooGarden = new Restaurant ('asian', 'Bamboo Garden Vegetarian', '$$', '364 Roy Street, Seattle, WA 98109', '(206) 282-6616', '11AM to 10PM', 'https://www.yelp.com/biz/bamboo-garden-vegetarian-cuisine-seattle', './images/asian/bambooGarden.jpg');
...
var tacosEl = new Restaurant ('mexican', 'Tacos El Asadero', '$', '3517 Rainier Ave S Seattle, WA 98118 Columbia City, Mount Baker', '(206) 722-9977', '10:00AM to 10:00PM', 'https://www.yelp.com/biz/tacos-el-asadero-seattle-2', './images/mexican/TacosEl.jpg');
...
var elLegend = new Restaurant ('mexican', 'El Legendario Mexican Restaurant', '$$', '4705 Aurora Ave N Seattle, WA 98103 b/t 47th St & 48th St  Fremont', '(206) 539-9731', '11:00AM to 10:00PM', 'https://www.yelp.com/biz/el-legendario-mexican-restaurant-seattle', './images/mexican/Legendario.jpg');
var laAnt = new Restaurant ('mexican', 'La Antigua Casa Maria', '$$$', '1100 N 115th St Ste 101 Seattle, WA 98133 b/t N Stone Ave & N Aurora Ave Haller Lake', '(206) 420-1158', '11:00AM to 10:00PM', 'https://www.yelp.com/biz/la-antigua-casa-maria-seattle', './images/mexican/LaAntigua.jpg');
var zocalo = new Restaurant ('mexican', 'Zocálo', '$$$', '224 Occidental Ave S Seattle, WA 98104 b/t Main St & Washington St  Pioneer Square', '(206) 623-0550', '11:00AM to 10:00PM', 'https://www.yelp.com/biz/zoc%C3%A1lo-seattle', './images/mexican/Zocalo.jpg');
var taqueria = new Restaurant ('mexican', 'Taqueria Cantina', '$$$', '2630 1st Ave Seattle, WA 98121 b/t Cedar St & Vine St Belltown','(206) 995-8588', '11:00AM to 11:00PM', 'https://www.yelp.com/biz/taqueria-cantina-seattle', './images/mexican/Taqueria.jpg');
...
var doria = new Restaurant ('Italian','Ristroante Doria','$$$','4759 Roosevelt Way NE, Seattle, WA 98105','(206)466-2380','4:00PM-10:00PM', 'https://www.yelp.com/biz/ristorante-doria-seattle', './images/italian/doria.jpg');
var spinasse = new Restaurant ('Italian','Spinasse','$$$','1531 14th Ave, Seattle, WA 98122','(206) 251-7673','5:00PM-11:00PM', 'https://www.yelp.com/biz/cascina-spinasse-seattle', './images/italian/spinasse.jpg');

var restaurants;

restaurants = [thanhSonTofu, aPieceOfCake, moonLight, bambooGarden, wedgwood, roti, harbor, sevenBeef, shiros, doria, moLuPasta, bizzarro, loPriore, salvatoreRistorante, mammaMelina, buca, tavolata, moLuPasta, spinasse, tacosC, elCam, tacosEl, fogon, villaEs, elLegend, laAnt, zocalo, taqueria];
